...
public class FilmController {
	...
	@PostMapping("/remove")
	public String removeFilm(@RequestParam Long idFilm, RedirectAttributes redirectAttrs) {
	...
	public String updateFilm(@Valid @ModelAttribute("edit_film_attr") FilmDTO filmDTO, BindingResult result,
		...
		if(filmDTO.getRegista() == null || filmDTO.getRegista().getId() == null) {
			...
			filmDTO.setRegista(RegistaDTO.buildRegistaDTOFromModel(registaService.caricaSingoloElemento(filmDTO.getRegista().getId())));
		}
